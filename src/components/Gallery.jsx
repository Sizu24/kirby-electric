    ...
    <div className="gallery">
      ...
      <div className="gallery-container">
        <div className="gallery__image-container gallery__image-container--one">
          <img className="gallery__image" src="/assets/images/gallery/AdobeStock_158770492_Preview.jpeg" alt="" />
        ...
        <div className="gallery__image-container gallery__image-container--two">
          <img className="gallery__image" src="/assets/images/gallery/AdobeStock_94044387_Preview.jpeg" alt="" />
        ...
        <div className="gallery__image-container gallery__image-container--eight">
          <img className="gallery__image" src="/assets/images/gallery/AdobeStock_63558488_Preview.jpeg" alt="" />
